...
/// / `?` produces a split, unconditionally. A subtitle line never contains two
/// sentence-terminal punctuation marks. Filler-word fragments ("Or.", "Um.")
/// are an ASR punctuation problem, not a segmentation problem — fixing them
/// here would require merging genuine short sentences like "God bless."
