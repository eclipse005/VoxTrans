...
本地化音视频转录与字幕翻译工具。完全离线运行，支持 10 种源语言的语音识别，以及 18 种语言的字幕互译。
...
- **多语种转录**：10 种源语言（英语、中文普通话、粤语、日语、韩语、法语、德语、意大利语、西班牙语、葡萄牙语）
...
VoxTrans 当前 UI 启用 10 种源语言（中英粤日韩德意西葡法）。实际可用的语言以对齐模型支持的 11 种为限：中、英、粤语、日、韩、法、德、西、意、葡、俄。
